...
<header x-data="{
    ...
    <div class="container-xxl flex items-center justify-between">
    <button @click="mobileSearchOpen = !mobileSearchOpen"><i class="fa-solid fa-magnifying-glass flex text-xl md:hidden"></i></button>
     <!-- serachMenu -->
    ...
    <div>
        <a href="{{ route('home') }}" class="block py-navbar-item pl-5 sm:text-xl mr-2 text-2xl"> XStore </a>
    </div>
    <!-- Responsive Menu -->
    <div
